...
//Swift 不会默认类型要指明 是Int 还是  String
...
if let theMonth = Month(rawValue: 8){
    //print("\(monthsBeforeNewYear(theMonth)) months before New Year!")  //swift 2
    print("\(monthsBeforeNewYear(month: theMonth)) months before New Year!")  //swift 2
}
...
let myFavoriteLanguage3: ProgrammingLanguage2 = .ObjectiveC
print( "\(myFavoriteLanguage3.rawValue) is my favorite language.")
